...
This is a CAD/3D model of a commercially available walker, created for visual purposes as part of a project from an undergraduate engineering student team ([BMERIT](https://linktr.ee/bmerit_ucalgary)). The files are available in STEP and SLDPRT (SolidWorks Education) format, with an assembled file also available in STEP format and as an OBJ with an MTL file for colouring.
