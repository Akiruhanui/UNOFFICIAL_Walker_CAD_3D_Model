# (UNOFFICIAL) CAD Model of a Commercially Available Walker
...
This is a CAD model of a commercially available walker, created for visual purposes as part of a project from an undergraduate engineering student team (BMERIT). The files are available in STEP and SLDPRT (SolidWorks Education) format, with an assembled file also available in STEP format and as an OBJ with an MTL file for colouring.
...
This was possible due to the permission and help of Allah (SWT), as is the case with everything. Additional help came from Alberta Health Services, who allowed our team to borrow the walker for our project.
